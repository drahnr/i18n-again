// https://github.com/drahnr/i18n-again/blob/v0.1.6/crates/support/src/lib.rs#L9
...
fn find_all_yaml_for_cargo_cache() {
    ...
    // /var/folders/qb/.../T/cargo-installcBf9L5/release/build/i18n-again-xxx/build-script-build
